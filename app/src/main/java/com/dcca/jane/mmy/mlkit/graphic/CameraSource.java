...
public class CameraSource {
  ...
  private final com.dcca.jane.mmy.mlkit.graphic.GraphicOverlay graphicOverlay;
  ...
  public CameraSource(Activity activity, com.dcca.jane.mmy.mlkit.graphic.GraphicOverlay overlay) {
        ...
        try {
          synchronized (processorLock) {
            frameProcessor.processByteBuffer(
                data,
                new com.dcca.jane.mmy.mlkit.graphic.FrameMetadata.Builder()
