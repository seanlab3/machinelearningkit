...
public class BitmapUtils {
  ...
  @Nullable
  public static Bitmap getBitmap(ByteBuffer data, com.dcca.jane.mmy.mlkit.graphic.FrameMetadata metadata) {
    data.rewind();
  ...
  public static Bitmap getBitmap(ImageProxy image) {
    com.dcca.jane.mmy.mlkit.graphic.FrameMetadata frameMetadata =
