...
public class CameraSourcePreview extends ViewGroup {
  ...
  private com.dcca.jane.mmy.mlkit.graphic.CameraSource cameraSource;

  private com.dcca.jane.mmy.mlkit.graphic.GraphicOverlay overlay;
  ...
  private void start(com.dcca.jane.mmy.mlkit.graphic.CameraSource cameraSource) throws IOException {
  ...
  public void start(com.dcca.jane.mmy.mlkit.graphic.CameraSource cameraSource, com.dcca.jane.mmy.mlkit.graphic.GraphicOverlay overlay) throws IOException {
  ...
  private void startIfReady() throws IOException, SecurityException {
    if (startRequested && surfaceAvailable) {
      ...
      if (overlay != null) {
        ...
        boolean isImageFlipped = cameraSource.getCameraFacing() == com.dcca.jane.mmy.mlkit.graphic.CameraSource.CAMERA_FACING_FRONT;
        if (isPortraitMode()) {
