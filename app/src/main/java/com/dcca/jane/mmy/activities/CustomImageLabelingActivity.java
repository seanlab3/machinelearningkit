...
import com.dcca.jane.mmy.mlkit.barcodescanner.BarcodeScannerProcessor;
import com.dcca.jane.mmy.mlkit.facedetector.FaceDetectorProcessor;
import com.dcca.jane.mmy.mlkit.graphic.CameraXViewModel;
import com.dcca.jane.mmy.mlkit.graphic.GraphicOverlay;
import com.dcca.jane.mmy.mlkit.graphic.VisionImageProcessor;
...
import com.dcca.jane.mmy.mlkit.labeldetector.LabelDetectorProcessor;
import com.dcca.jane.mmy.mlkit.objectdetector.ObjectDetectorProcessor;
import com.dcca.jane.mmy.mlkit.posedetector.PoseDetectorProcessor;
import com.dcca.jane.mmy.mlkit.segmenter.SegmenterProcessor;
import com.dcca.jane.mmy.mlkit.textdetector.TextRecognitionProcessor;
...
public final class CustomImageLabelingActivity extends AppCompatActivity
    implements OnRequestPermissionsResultCallback,
        OnItemSelectedListener,
        CompoundButton.OnCheckedChangeListener {
  private static final String TAG = "CustomImageLabeling";
...
//                  .build();
          LocalModel localClassifier =
              new LocalModel.Builder()
                  .setAssetFilePath("bt/model.tflite")
                  .build();
...
//              new LocalModel.Builder().setAssetManifestFilePath("automl/manifest.json").build();
          LocalModel customAutoMLLabelLocalModel =
              new LocalModel.Builder().setAssetManifestFilePath("bt/manifest.json").build();
